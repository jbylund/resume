...
\begin{bullets}
    ...
    \item \blead{Search service}built the search microservice for companies, facilities and transactions, and the synchronous and asynchronous ArangoDB http client behind it (python, FastAPI, Pydantic, ArangoDB).
    ...
    \item \blead{Geocoding}built a continuous address geocoding pipeline and its api client, geocoded {\mytilde}400 million addresses, and measured and improved match accuracy (python).
\end{bullets}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%   Kensho    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{bullets}
    ...
    \item \blead{Company identification}migrated the fuzzy matching service to kubernetes, then profiled and parallelized it for a {\mytilde}3x speedup (python, kubernetes).
