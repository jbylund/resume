...
\begin{bullets}
    \item \textbf{Sylvan Librarian} (\href{https://sylvan-librarian.com/}{sylvan-librarian.com}, \href{https://github.com/jbylund/sylvan_librarian}{source}) --- open source Magic: The Gathering card search engine in rust, implementing Scryfall's query syntax and extending it with arithmetic expressions. Self-hosted with blue/green deploys behind nginx; independently forked and deployed to Cloudflare Workers by an outside contributor (rust, python).
