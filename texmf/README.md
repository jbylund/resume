...
| --- | --- | --- | --- |
| `DejaVuSans.sty` | `dejavu` | `texlive-fonts-extra` | 656 MB |
...
172 KB vendored replaces 834 MB of downloads. CI therefore installs only
...
Copied from Debian `texlive-latex-extra` / `texlive-fonts-*` version
