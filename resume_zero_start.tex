...
%
%   103%  ->  3 pages, last page 79% full
%   104%  ->  3 pages, last page 86% full   <-- current setting
%   105%  ->  3 pages, last page 97% full
%   106%  ->  3 pages, last page 98% full
%   107%  ->  spills onto a 4th page
%
% 104% rather than 105% on purpose: 105 fills the page more but leaves no room to
% add a line. If content grows and the build fails the page check, drop a point
% rather than editing individual sizes.
%
% Was 107% until the header gained a links line and Open Source gained the
% typeshed entry, which together cost about three points of scale.
%
