...
%
%   104%  ->  3 pages, last page 74% full, 13 lines spare
%   106%  ->  3 pages, last page 99% full,  0.3 lines spare
%   107%  ->  3 pages, last page 91% full,  4.7 lines spare   <-- current setting
%   108%  ->  spills onto a 4th page
%
% 107% rather than 106% on purpose: 106% fills the page more but leaves no room to
% add a line. If content grows and the build fails the page check, drop to 104
